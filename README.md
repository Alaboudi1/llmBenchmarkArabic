...
السياق هو مجموعة من المعلومات المقدمة كمدخل ضمن الأمر النصي (prompt) للنموذج اللغوي. فعلى سبيل المثال، بدل من أن تقول للنموذج اللغوي "من هو أحمد؟" وتتوقع منه الإجابة الصحيحية، تعطية لمحة تاريخية عن شخصية أحمد وسيرته الذاتية قبل طرح سؤالك. هناك فائدتان رئيسيتان للسياق في النماذج اللغوية الكبيرة:
